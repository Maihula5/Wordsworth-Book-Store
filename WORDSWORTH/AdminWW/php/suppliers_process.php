...
function get_user_order(){
    ...
    $var2 ='';
    $var2 = $_SESSION['id'];    
     $sql = "SELECT o.oid, o.bid, o.customer_id, o.delivery_address, o.order_date, d.qty FROM `order`o, `order_details`d WHERE o.oid= d.OID AND o.customer_id = $var2 ORDER BY o.`order_date`";
